...
if ($result1->num_rows > 0) {
 ...
 $sql2 = "INSERT INTO cart(pro_id,pro_name,pro_price,pro_image,userid,quantity,orderstatus,uname) values('$idone', '$namesession1', '$pricesession','$imagesession','$personid',1,'requested','$namesession')";
