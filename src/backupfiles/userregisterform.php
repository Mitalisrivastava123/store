...
<nav class="navbar navbar-expand-lg navbar-light nav1">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="userloginform.php"><span class="dash1">User Registration Page</span></a>
      </li>
...
<section class="vh-100 bg-image"
  style="background-image: url('https://mdbcdn.b-cdn.net/img/Photos/new-templates/search-box/img4.webp');  border: 2px solid black;
  padding: 25px;
          ...
          <div class="card" style="border-radius: 15px;">
            <div class="card-body p-5">
              ...
              <form action="register.php" method="POST">
                ...
                <p class="text-center text-muted mt-5 mb-0">Have already an account? <a href="userloginform.php"
